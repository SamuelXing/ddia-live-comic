...
export const structuredStreaming: Chapter = {
  ...
  steps: [
    ...
    },
    {
      ...
      span: 2,
      body: [
        'Not one of these is an algorithm, and that is the chapter. By this point in a technology the hard problems left are about who has to understand what.',
      ],
      diagram: (
        <DesignIt
          spec={{
    ...
    },
    {
      ...
      body: [
        ...
        '**What this act has settled.** Three chapters ago the middle of a computation had to go through a replicated file system between every stage. Now it can stay in memory and survive a dead machine; the input is allowed to keep arriving while the work is going on; and the query can be written by somebody who has never thought about incremental computation. The delay came down from hours to seconds, and each rung was bought with something specific — a restriction on writes, a global checkpoint, a ceiling on what you can express.',
        '**And here is the assumption that all three chapters have been quietly making.** Every one of them reads arrival order as a stand-in for the order of events. It is a completely reasonable assumption when the input is a file you already have, and it survived the move to a stream because the streams in this act came out of a message bus in a datacentre. Now put the source in someone’s pocket. A purchase happens at 09:14 on a phone in a tunnel, and reaches you at 13:40 — long after you computed the morning’s total, published it, and told everyone it was final. *Nothing in this act has a way to be right about that*, and the next one is about what it costs to be.',
      ],
    },
  ],
  bubbles: [
