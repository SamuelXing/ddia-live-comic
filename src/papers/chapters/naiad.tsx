...
export const naiad: Chapter = {
  ...
  inTheWild: {
    ...
    points: [
      ...
      '**Checkpoint frequency is a dial with no good setting.** Frequent enough to keep recovery short means paying the pause and the throughput cost constantly; rare enough to be cheap means a failure costs minutes of reprocessing across every machine. The measured throughput range — roughly 480k down to 274k records a second — is what that dial actually spans.',
