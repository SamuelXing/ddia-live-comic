  ...
  steps: [
    ...
    },
    {
      ...
      body: [
        ...
        'The measured result is the sawtooth in the figure. Between polls the daemon widens ε at a deliberately conservative **200 microseconds per second** of assumed drift, so ε sawtooths from about **1 ms just after a poll to about 7 ms just before the next**, thirty seconds later — averaging near **4 ms**. Roughly 6 of those milliseconds are the drift ramp and 1 is the network round trip to the masters.',
