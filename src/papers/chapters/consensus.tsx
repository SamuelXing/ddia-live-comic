...
export const consensus: Chapter = {
  ...
  steps: [
    ...
    },
    {
      ...
      span: 2,
      body: [
        'Two of these build the algorithm. The last one is what the chapter is actually about, and it is not a question about distributed systems — it is a question about whether anybody can read what you wrote.',
      ],
      diagram: (
        <DesignIt
          spec={{
