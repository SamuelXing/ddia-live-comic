...
export const millwheel: Chapter = {
  ...
  steps: [
    ...
    },
    {
      ...
      span: 2,
      body: [
        'Nothing in a stream announces that it is finished, and this act is named after what you do about that. Then what happens when you get it wrong, which you will. Then what it costs to never count a record twice.',
      ],
      diagram: (
        <DesignIt
          spec={{
