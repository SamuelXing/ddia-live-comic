...
export const flinkSnapshots: Chapter = {
  ...
  steps: [
    ...
    },
    {
      ...
      span: 2,
      body: [
        'Two decisions, which is unusual for this book and honest for this paper — it is eight pages and it does one thing. The second one is where almost everybody gets it wrong on the first try.',
      ],
      diagram: (
        <DesignIt
          spec={{
