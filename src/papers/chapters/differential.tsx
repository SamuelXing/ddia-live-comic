...
export const differential: Chapter = {
  ...
  steps: [
    ...
    },
    {
      ...
      span: 2,
      body: [
        'Two decisions. The first is the paper and the second is the bill it runs up — and the first one is unusual for this book in that the wrong answers are not merely worse, they are *impossible*, which takes a minute to see.',
      ],
      diagram: (
        <DesignIt
          spec={{
    ...
    },
    {
      ...
      deeper: {
        ...
        body: [
          ...
          '*The general lesson is worth more than the mechanism.* A model this expressive needs a correct universal implementation and a fast path for the cases people actually use — and the honest way to present one is to give the slow general rule first and then say which operators escape it. **A paper that only shows you the fast path is telling you about a special case and calling it a system.**',
        ],
      },
    },
    {
